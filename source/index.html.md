...
toc_footers:
  ...
  - <a href='https://learn.retreaver.com/'>Knowledge Base</a>
...
include_fields[] | `include_fields[]=uuid&include_fields[]=status` | | Array parameter. List of fields to include in each call object. Only the specified fields will be returned. If `exclude_fields[]` is also present, the `exclude_fields[]` param will be ignored.
exclude_fields[] | `exclude_fields[]=postback_value&exclude_fields[]=tags` | | Array parameter. List of fields to omit from each call object. All other fields will be returned. If `include_fields[]` is also present, the `exclude_fields[]` param will be ignored.
